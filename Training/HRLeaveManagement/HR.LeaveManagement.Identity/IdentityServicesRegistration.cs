...
public static class IdentityServicesRegistration
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddDbContext<LeaveManagementIdentityDbContext>(opt =>
            opt.UseSqlServer(configuration.GetConnectionString("LeaveManagementConnectionString"), b =>
                b.MigrationsAssembly(typeof(LeaveManagementIdentityDbContext).Assembly.FullName)));
